...
/**
 *The JUnit tests for the Ex2 class thoroughly examine its functionality across multiple methods,
 * including operations like translation, rotation, scaling, and color changes. These tests ensure that
 *expected changes occur accurately by comparing shape information before and after method
 * execution. They validate the correctness of Ex2's behavior in diverse scenarios, covering a wide
 * array of functions within the class.
 *
...
class Ex2Test {
    ...
    void testNone() {
        ...
        Assertions.assertFalse(ex2.getShape_Collection().get(2).isSelected());
        Assertions.assertFalse(ex2.getShape_Collection().get(3).isSelected());
        Assertions.assertTrue(ex2.getShape_Collection().get(4).isSelected());

        ex2.actionPerformed("Anti");
        Assertions.assertFalse(ex2.getShape_Collection().get(0).isSelected());
        Assertions.assertFalse(ex2.getShape_Collection().get(1).isSelected());
        ...
        Assertions.assertFalse(ex2.getShape_Collection().get(4).isSelected());
